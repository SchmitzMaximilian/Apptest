...
const Navbar=(Prop)=> { 
  ...
  return (
    ...
    <Stack.Navigator initialRouteName="SeiteTest" screenOptions={{headerShown:false, headerMode:'screen', headerTintColor:'white', headerStyle: {backgroundColor:'rgba(0,15,40,0.95)'}}}>
