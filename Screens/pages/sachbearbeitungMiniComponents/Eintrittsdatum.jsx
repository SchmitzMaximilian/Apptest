...
function EintrittsdatumSelect(props) {
...
const handleChange = (event, selectedDate) => { 
  ...
  let Obj=props.SV
  Obj.Eintrittsdatum=Intl.DateTimeFormat('de-DE',{dateStyle:'short'}).format(currentDate).toString()
  ...
  props.SF(Obj)
    ...
    useEffect(() => {
      ...
      if(props.SV.Eintrittsdatum=="")
        {
          if(!sprache){
              setDateText("Eintrittsdatum")
          }else if(sprache){
            setDateText("Eintrittsdatum")
          }
        }
...
export default EintrittsdatumSelect