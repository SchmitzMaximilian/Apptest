...
export const Checkboxdataset=(p)=>{
  ...
  if(p=="DE"){
   ...
   "TopSelectboxenLabel":["Geschlecht","Art der Krankenversicherung (Pflichtangabe, zutreffendes makieren)","Höchster allgemeinbildender Schulabschluss [TS-6](Pflichtangabe, Zutreffendes bitte makieren)","Höchster beruflicher Ausbildungsabschluss [TS 7](Pflichtangabe, Zutreffendes bitte makieren)","in"],
     ...
     ["(1)Gesetzlich","(2)Freiwillig","(3)Privat","(4)Ich habe oder hatte eine Elterneigensschaft (Nachweis z.B. Geburtsurkunde)","(5)Ich bin nicht Rentenversicherungspflichtig (z.B. Beamter oder Selbständiger, Nachweis)","(6)Ich übe neben dieser noch weitere Beschäftigungen aus(Bitte fügen Sie eine vollständige Liste aller weiteren Arbeitgeber bei)","(7)Dies ist nicht meine Hauptbeschäftigung"],
   ...
   BoxData={
     "TopSelectboxenLabel":["Gender","Type of health insurance (mandatory information, mark as applicable)","Highest general school leaving certificate [TS-6](Mandatory information, please mark as applicable)","Highest professional training qualification [TS 7](Mandatory information, please mark as applicable)",""],
       ...
       ["(1)Legally","(2)Voluntarily","(3)Private","(4)I have or had parental status (proof e.g. birth certificate)","(5)I am not subject to pension insurance (e.g. civil servant or self-employed, include proof)","(6)I have other jobs besides this one (please include a complete list of all other employers)","(7)This is not my main job"],
